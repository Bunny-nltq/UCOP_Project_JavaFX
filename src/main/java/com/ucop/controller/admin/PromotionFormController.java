...
public class PromotionFormController {
    ...
    private void handleSave() {
        try {
            ...
            PromotionDAO dto = createDTOFromForm();
    ...
    private PromotionDAO createDTOFromForm() {
    ...
    private void closeDialog() {
        if (dashboardController != null) {
            ...
            // Return to promotion management in admin dashboard
            Platform.runLater(() -> adminDashboardController.showPromotionManagement());
